    ...
    describe('Route Config', function () {
      ...
      describe('Create Route', function () {
        ...
        beforeEach(inject(function ($controller, $state, $templateCache) {
          ...
          $templateCache.put('modules/customers/client/views/create-customer.client.view.html', '');
        ...
        it('Should have templateUrl', function () {
          expect(createstate.templateUrl).toBe('modules/customers/client/views/create-customer.client.view.html');
        });
      });
      ...
      describe('Edit Route', function () {
        ...
        it('Should have templateUrl', function () {
          expect(editstate.templateUrl).toBe('modules/customers/client/views/create-customer.client.view.html');
        });
